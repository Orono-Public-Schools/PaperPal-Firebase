    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: "radial-gradient(circle, #4356a9, transparent)",
          }}
        />
        <div
          className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full opacity-10"
          style={{
            background: "radial-gradient(circle, #ad2122, transparent)",
          }}
        />
      </div>
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            const shimmer =
              e.currentTarget.querySelector<HTMLSpanElement>(".shimmer")
        ...
        >
          <span
            className="shimmer pointer-events-none absolute top-0 h-full w-full"
            style={{
              left: "-100%",
              background:
